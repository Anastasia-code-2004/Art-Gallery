...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ArtGallerySystem.UI.dll" comes first in this list. */
		"ArtGallerySystem.UI.dll",
		"Camera.MAUI.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"ArtGallerySystem.Application.dll",
		"ArtGallerySystem.Domain.dll",
		"ArtGallerySystem.Persistense.dll",
