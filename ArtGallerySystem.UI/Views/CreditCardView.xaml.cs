using ArtGallerySystem.UI.Helpers.ExtensionMethods;
using ArtGallerySystem.UI.Helpers;
using System.Globalization;

namespace ArtGallerySystem.UI.Views;
...
public partial class CreditCardView
{
    ...
    private void SetCreditCardNumber()
    {
        ...
        {
            CardFront.BackgroundColor = (Color)Microsoft.Maui.Controls.Application.Current?.Resources["Default"];
            CardBack.BackgroundColor = (Color)Microsoft.Maui.Controls.Application.Current?.Resources["Default"];
            CreditCardImageLabel.Text = "\uf09d";
            CreditCardImageLabel.FontFamily = "FA6Regular";
        }
    ...
    public static readonly BindableProperty IsSelectedProperty =
        BindableProperty.Create(nameof(IsSelected), typeof(bool), typeof(CreditCardView), false);
